function FilterMenuSidebar({ categories, brands }) {
  return (
    <div className="px-20">
      <div className="bg-[#fff] hidden font-medium text-[0.9rem] w-[23%] h-full px-8 py-6 text-left overflow-scroll [scrollbar-width:none] xl:block">
