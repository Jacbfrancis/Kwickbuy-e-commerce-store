  ...
  return (
    <div>
      <div className="bg-[#fff] shadow-sm px-6 py-4 border-[#6cc6e73f] border-1 xl:rounded-xl">
        <form>
          <div className="flex flex-col justify-center items-center xl:flex-row xl:justify-between">
          ...
          <span className="flex flex-col my-4">
            ...
            <select className="text-gray-600 w-full mt-1 p-3 border-1 border-[#6cc6e786] block rounded-md focus:outline-0">
          ...
          <span className="flex flex-col my-4">
            ...
            <select className="text-gray-600 w-full mt-1 px-3 py-2 border-1 border-[#6cc6e786] block rounded-md focus:outline-0">
